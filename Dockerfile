Use a base image that includes Python and is Debian-based for easy package installation
...
The exec form ensures signals are handled correctly.
The 0.0.0.0 binding is necessary for container platforms.
